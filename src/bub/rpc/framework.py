...
class JSONRPCFramework:
    ...
    def register_method(self, name: str, handler: Callable[[dict[str, object]], Awaitable[dict[str, object]]]) -> None:
    ...
    def on_notification(self, method: str, handler: Callable[[dict[str, object]], Awaitable[None]]) -> None:
