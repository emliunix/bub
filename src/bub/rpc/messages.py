...
class ConfigureContent(TypedDict):
    """Content for configure message."""

    talkto: str


class ConfigurePayload(TypedDict):
    """Payload for configure message."""
...
class AgentEventContent(TypedDict):
    """Content for agent_event (lifecycle/control events)."""
...
MessagePayload = (
    SpawnRequestPayload | SpawnResultPayload | ConfigurePayload | TgMessagePayload | TgReplyPayload | AgentEventPayload
)
...
def create_plaintext_payload(
    message_id: str,
    from_addr: str,
    timestamp: str,
    text: str,
) -> dict[str, object]:
    """Create a plaintext_message payload dict."""
    return {
        "messageId": message_id,
        "type": "plaintext_message",
        "from_": from_addr,
        "timestamp": timestamp,
        "content": {
            "text": text,
