...
- **REPL** (`repl.py`, `repl_session.py`, `repl_driver.py`): Interactive environment
...
1. **LLM Agent Synthesizer**: Implement `LLMSynth.get_primop()`
...
- **REPL**: `cd systemf && uv run python -m systemf.elab3.repl_driver`
